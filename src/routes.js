...
import AddClass from 'src/layouts/LayoutAddClass/views/addClass';
import {LoginView} from 'src/layouts/LayoutLogin/views/LoginView';
import NotFoundView from 'src/layouts/Layout404/views/NotFoundView';
import ClassListView from 'src/layouts/LayoutDashboard/views/ViewClassStudent/index.js';
import SettingsView from 'src/layouts/LayoutDashboard/Settings';
import ResourcesList from 'src/layouts/LayoutResourceForm/views';
import Messaging from 'src/layouts/LayoutDashboard/views/ViewMessaging/index';
import Notifications from 'src/layouts/LayoutDashboard/views/ViewNotifications/index';
import TeacherCard from 'src/layouts/LayoutDashboard/views/ViewClassTeacher/index';
import {Register} from 'src/layouts/LayoutRegister/views/Register';
