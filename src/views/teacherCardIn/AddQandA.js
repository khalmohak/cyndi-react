...
const AddQandA = ({className, ...rest}) => {
  ...
  return (
    <div>
      ...
      >
        <MenuItem onClick={e => handleOpenModal("Quiz")} value={"Quiz"}>Quiz</MenuItem>
        <MenuItem onClick={e => handleOpenModal("Exam")} value={"Exam"}>Exam</MenuItem>
        <MenuItem onClick={e => handleOpenModal("Survey")} value={"Survey"}>Survey</MenuItem>
      </Menu>
      ...
      >
        <Fade in={open}>
          <div className={classes.paper}>
            <h3 id="transition-modal-title">Add QES</h3>
            <form>
              <TextField
                label="Title"
                id="formTitle"
